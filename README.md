...
# Start vnc server
docker exec --privileged -it c2 bash -c "./start_vnc.sh"

# start appium
docker exec --privileged -it c2 bash -c "./start_appium.sh"
...
adb shell am start -n app.example.butomo.sampleapplication
